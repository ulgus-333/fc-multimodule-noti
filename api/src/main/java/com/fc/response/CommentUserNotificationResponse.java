...
public class CommentUserNotificationResponse extends UserNotificationResponse {
    ...
    public CommentUserNotificationResponse(String id, NotificationType type, Instant occurredAt, String userName, String userProfileImage, String comment, String postImageUrl) {
